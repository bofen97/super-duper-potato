...
class LiftSimAgent(parl.Agent):
    ...
    def learn(self,obs,act,adv,vtag):
        ...
        total_loss,piloss,ent,vloss=self.fluid_executor.run(self.learn_program,feed=feed,fetch_list =self.loss_array)
        return total_loss[0],piloss[0],vloss[0],ent[0],lr,entropy_coeff
